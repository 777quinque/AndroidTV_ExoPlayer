...
class CompositeAdapterForChannels(
    private val channelAdapter: ChannelAdapterForChannels,
    private val filterAdapter: FilterAdapterForChannels
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (useFilterAdapter) {
            filterAdapter.onBindViewHolder(holder as FilterAdapterForChannels.ViewHolder, position)
        } else {
            channelAdapter.onBindViewHolder(holder as ChannelAdapterForChannels.ViewHolder, position)
        }
    }
